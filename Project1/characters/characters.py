...
def main():
    """
    脚本主入口：运行 'characters' 图像的复现。
    """
    
    # --- 用户配置区 ---
    IMAGE_FILES = {
        'characters': Path("characters/characters.jpg"), 
    }

    # 论文中报告的阈值 [Wang&Bai, Otsu, Kapur]
    EXPECTED_THRESHOLDS = {
        'characters': {'wang_bai': 148, 'otsu': 147, 'kapur': 167},
    }
    # --- 结束配置区 ---
    ...
    if all_results:
        ...
        print("\n未处理任何图像。请检查 IMAGE_FILES 字典中的 'characters' 文件路径。")
