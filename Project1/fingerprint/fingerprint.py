...
def main():
    """
    脚本主入口：运行 'fingerprint' 图像的复现。
    """
    
    # --- 用户配置区 ---
    IMAGE_FILES = {
        'fingerprint': Path("fingerprint/fingerprint.bmp"),      
    }

    # 论文中报告的阈值 [Wang&Bai, Otsu, Kapur]
    EXPECTED_THRESHOLDS = {
        'fingerprint': {'wang_bai': 122, 'otsu': 125, 'kapur': 142},
    }
    # --- 结束配置区 ---
    ...
    if all_results:
        ...
        print("\n未处理任何图像。请检查 IMAGE_FILES 字典中的 'fingerprint' 文件路径。")
