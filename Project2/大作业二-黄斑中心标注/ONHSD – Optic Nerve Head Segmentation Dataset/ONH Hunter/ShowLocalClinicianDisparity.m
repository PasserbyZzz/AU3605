...
% and local models drawn on.

function [ONHDisparity, ONHNormDisparity] = ShowLocalClinicianDisparity( GlobalPostfix, LocalPostfix, Range )
...
%    ONHPlotLocalModel( ONHCentre, ONHMeanEdge' + 2 * ONHsdEdge', [ 1 0.5 0.5 ] );
    ...
    ONHPlotLocalModel( ONHCentre, ONHSpokes, [ 1 1 0.5 ] );
end
