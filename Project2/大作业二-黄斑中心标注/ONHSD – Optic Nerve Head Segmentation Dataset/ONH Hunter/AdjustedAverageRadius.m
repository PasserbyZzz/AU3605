% AdjustedRadius - determine the average radius given distances along spokes, adjusting
% for the elliptical model shape.
% Utility routine for local model fitting
...
function radius = AdjustedAverageRadius( S )
